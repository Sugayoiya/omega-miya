...
from src.service.omega_message_context.custom_depends import OPTIONAL_REPLY_ARTWORK_CONTEXT
...
async def handle_show_artwork(context: OPTIONAL_REPLY_ARTWORK_CONTEXT) -> None:
